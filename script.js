...
// How can Day.js be used to get the current hour in 24-hour time?
  // Using 24 hour time format as the id 

    // declaring the time (10) to be 10:00 to test functionality of the time block
    const nowHour = 10
    // hourColour function changes the blockHour style based on past, present or future 
    // referenced to the time
    function hourColour() {
      $('.time-block').each(function() {
        // declare the blockHour by calling upon the id identifified in the html as a string 09,10,11,12,13,14,15,16,17 through this
